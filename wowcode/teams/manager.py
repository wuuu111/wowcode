...
from wowcode.teams.backend_detect import BackendDetectionError, detect_backend
from wowcode.teams.mailbox import Mailbox, create_message
...
from wowcode.teams.progress import TeammateProgress
from wowcode.teams.registry import AgentNameRegistry
from wowcode.teams.shared_task import SharedTaskStore
from wowcode.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from wowcode.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
