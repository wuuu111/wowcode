...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from wowcode.agents.fork import ForkError, build_forked_messages
        from wowcode.agents.parser import AgentDef
        from wowcode.agents.tool_filter import resolve_agent_tools
        from wowcode.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from wowcode.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from wowcode.agents.fork import ForkError, build_forked_messages
        from wowcode.agents.parser import AgentDef
        from wowcode.agents.tool_filter import build_teammate_tools
        from wowcode.agent import Agent as AgentClass
        from wowcode.conversation import ConversationManager
        from wowcode.permissions import (
            DangerousCommandDetector,
        ...
        from wowcode.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from wowcode.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from wowcode.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from wowcode.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from wowcode.client import create_client
        from wowcode.config import ProviderConfig
