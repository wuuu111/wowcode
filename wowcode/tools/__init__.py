...
def create_default_registry(file_cache: FileCache | None = None, file_history: Any = None) -> ToolRegistry:
    from wowcode.tools.bash import Bash
    from wowcode.tools.edit_file import EditFile
    from wowcode.tools.file_state_cache import FileStateCache
    from wowcode.tools.glob import Glob
    from wowcode.tools.grep import Grep
    from wowcode.tools.read_file import ReadFile
    from wowcode.tools.write_file import WriteFile
