...
from wowcode.commands import (
    CommandContext,
    CommandRegistry,
    complete,
    parse_command,
)
from wowcode.commands.completion import CompletionPopup
from wowcode.commands.handlers import register_all_commands
from wowcode.config import MCPServerConfig, ProviderConfig
from wowcode.hooks import HookContext, HookEngine, load_hooks
from wowcode.conversation import ConversationManager, Message
from wowcode.mcp import ConnectResult, MCPManager
from wowcode.memory import (
    MemoryManager,
    Session,
    SessionManager,
...
from wowcode.agents.notification import inject_task_notifications
from wowcode.commands.handlers.tasks import create_tasks_command
from wowcode.skills.executor import SkillExecutor
from wowcode.skills.loader import SkillLoader
from wowcode.commands.handlers.skill_register import register_skill_commands
from rich.text import Text as RichText
from textual.theme import Theme
from wowcode.cache import FileCache
from wowcode.tools import ToolRegistry, create_default_registry
from wowcode.tools.agent_tool import AgentTool
from wowcode.tools.ask_user import AskUserEvent, AskUserTool
from wowcode.tools.impl.tool_search import ToolSearchTool
from wowcode.tools.load_skill import LoadSkill
from wowcode.worktree.cleanup import start_stale_cleanup_task
from wowcode.worktree.manager import WorktreeManager
from wowcode.commands.handlers.worktree import create_worktree_command
from wowcode.teammate_tree import TeammateTree
...
_SKIP_DIRS = {".git", "node_modules", ".venv", "__pycache__", ".wowcode", "build", ".gradle"}
...
class ChatInput(TextArea):
    ...
    def load_history(self, work_dir: str) -> None:
        self._history_file = Path(work_dir) / ".wowcode" / "history"
...
class WowCodeApp(App):
    ...
    def __init__(
        ...
        from wowcode.config import SandboxAppConfig
    ...
    def on_mount(self) -> None:
        self.register_theme(_WOWCODE_THEME)
        self.theme = "wowcode"
        if len(self.providers) == 1:
    ...
    def _select_provider(self, provider: ProviderConfig) -> None:
        ...
        from wowcode.filehistory import FileHistory
        ...
        from wowcode.tools.exit_plan_mode import ExitPlanModeTool
        ...
        from wowcode.tools.enter_worktree import EnterWorktreeTool
        from wowcode.tools.exit_worktree import ExitWorktreeTool
        ...
        from wowcode.commands.handlers.trace import create_trace_command
        ...
        from wowcode.tools.synthetic_output import SyntheticOutputTool
    ...
    async def _show_plan_approval(self) -> None:
        from wowcode.plan_dialog import InlinePlanWidget
    ...
    def on_inline_plan_widget_responded(
        ...
        from wowcode.plan_dialog import InlinePlanWidget, PlanChoice
        from wowcode.prompts import build_plan_mode_exit_reminder
    ...
    async def _handle_askuser(self, event: AskUserEvent) -> None:
        from wowcode.askuser_dialog import InlineAskUserWidget
    ...
    async def _handle_permission_request(self, request: PermissionRequest) -> None:
        from wowcode.permission_dialog import InlinePermissionWidget
