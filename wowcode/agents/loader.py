...
PROJECT_AGENTS_DIR = ".wowcode/agents"
USER_AGENTS_DIR = "~/.wowcode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("wowcode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from wowcode.agents.parser import parse_frontmatter, _validate_agent_meta
