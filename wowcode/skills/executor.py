...
from wowcode.skills.parser import SkillDef, substitute_arguments
from wowcode.tools import ToolRegistry

if TYPE_CHECKING:
    from wowcode.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from wowcode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
