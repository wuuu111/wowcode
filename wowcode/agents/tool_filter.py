...
def build_teammate_tools(
    ...
    from wowcode.tools.send_message import SendMessageTool
    from wowcode.tools.task_create import TaskCreateTool
    from wowcode.tools.task_get import TaskGetTool
    from wowcode.tools.task_list import TaskListTool
    from wowcode.tools.task_update import TaskUpdateTool
